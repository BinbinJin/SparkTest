...
object ScoreIDMerge {
  def main(args: Array[String]) {
    ...
    val test = sc.textFile("C:\\Users\\zjcxj\\Documents\\Visual Studio 2015\\Projects\\SVD++\\SVD++\\data\\all\\train.txt").map{x=>
      val info = x.split(" ")
    ...
    val score = sc.textFile("C:\\Users\\zjcxj\\Documents\\Visual Studio 2015\\Projects\\SVD++\\SVD++\\score.txt").zipWithIndex().map(_.swap)

    test
      .join(score)
      .map(x=>x._2._1._1+","+x._2._1._2+","+x._2._2)
      .repartition(1)
      .saveAsTextFile("C:\\Users\\zjcxj\\Documents\\Visual Studio 2015\\Projects\\SVD\\SVD\\trainScore")
